...
namespace FarApi.Controllers
{
    public class dbConfig : ControllerBase
    {
        ...
        // local server
        // public string dbCon = "Server=imranejaz440-pc/sql12;Initial Catalog=FAR;Persist Security Info=False;User ID=far;Password=baraniiha@123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Connection Timeout=30;";
